...
![docker stars](https://img.shields.io/docker/stars/urbica/gis-notebook.svg) [![](https://images.microbadger.com/badges/image/urbica/gis-notebook.svg)](https://microbadger.com/images/urbica/gis-notebook "urbica/gis-notebook image metadata")
...
* csv, fiona, gdal, geocoder, geopandas, geopy, googlemaps, psycopg2, pyproj, rtree, shapely pre-installed
...
```
docker run -d -p 8888:8888 urbica/gis-notebook
```
...
c.DockerSpawner.container_image = 'urbica/gis-notebook'
